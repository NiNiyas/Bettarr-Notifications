...
discordmessage = {
    ...
    'embeds': [
        {
            'author': {
                'name': script_config.sonarr_discord_user,
            ...
            'fields': [
                ...
                {
                    "name": 'Visit Sonarr',
                    "value": '[{}]({})'.format("Sonarr", script_config.sonarr_url),
                    "inline": False
                },
            ],
        },
...
discordsender = requests.post(script_config.sonarr_discord_url, headers=discord_headers, json=discordmessage)
...
slacksender = requests.post(script_config.sonarr_slack_url, headers=discord_headers, json=slackmessage)
